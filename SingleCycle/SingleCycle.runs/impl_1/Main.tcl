...
set rc [catch {
  ...
  add_files -quiet D:/WorkEnvironment/Vivado/VivadoProject/SingleCycle/SingleCycle.runs/synth_1/Main.dcp
...
set rc [catch {
  ...
  catch {update_ip_catalog -quiet -current_ip_cache {d:/WorkEnvironment/Vivado/VivadoProject/SingleCycle/SingleCycle.cache} }
  opt_design 
...
set rc [catch {
  ...
  catch { report_timing_summary -warn_on_violation -file Main_timing_summary_routed.rpt -pb Main_timing_summary_routed.pb }
